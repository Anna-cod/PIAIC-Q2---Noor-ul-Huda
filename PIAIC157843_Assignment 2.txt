...
def function5():
    ...
    z = np.zeros(4*5,dtype=int).reshape(4,5)#wrtie your code here
...
def function8():
    ...
    x = x = np.arange(2*5,dtype = np.uint32).reshape(2,5)
    x = np.full_like(x,6)#write your code here
...
def function9():
    ...
    a = = np.arange(2,2*50+1)# write your code here
...
def function12():
    ...
    b = np.repeat(arr,3)
    ans = np.hstack((b,ans)) #write your code here 
...
def function13():
    ...
    ans = [(arr>5)&(arr<10)]
    ans = np.extract(ans,arr)#write your code here 
...
def function15():
    ...
    ans = [1,0,2]
    arr = arr[ans]#write your code here 
